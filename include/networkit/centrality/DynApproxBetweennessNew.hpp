...
// networkit-format
#ifndef NETWORKIT_CENTRALITY_DYN_APPROX_BETWEENNESS_NEW_HPP_
#define NETWORKIT_CENTRALITY_DYN_APPROX_BETWEENNESS_NEW_HPP_
 ...
 */
class DynApproxBetweennessNew : public Centrality, public DynAlgorithm {
...
public:
     ...
     */
    DynApproxBetweennessNew(const Graph &G, double epsilon = 0.01, double delta = 0.1,
                            bool storePredecessors = true, double universalConstant = 1.0);

    ~DynApproxBetweennessNew();
...
#endif // NETWORKIT_CENTRALITY_DYN_APPROX_BETWEENNESS_NEW_HPP_
